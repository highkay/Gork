...
func decodeByparrResponse(raw []byte, target string) (clearanceSolveResult, bool, error) {
	...
	return clearanceSolveResult{
		Cookies:       extractClearanceCookies(selectClearanceCookies(result.Solution.Cookies, host)),
		UserAgent:     userAgent,
		ClearanceHost: host,
	}, true, nil
}
